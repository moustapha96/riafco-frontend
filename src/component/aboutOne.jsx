...
export default function AboutOne(){
    return(
        <div className="grid md:grid-cols-2 grid-cols-1 items-center mt-16 gap-[30px]">
            <div className="relative wow animate__animated animate__fadeInLeft" data-aos="fade-right">
            ...
            <div className="lg:ms-8 wow animate__animated animate__fadeInRight" data-aos="fade-left">
