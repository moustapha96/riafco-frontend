    ...
    return(
        <div className="container relative md:mt-24 mt-16">
            <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                <div className="relative order-1 md:order-2 " data-aos="fade-left" data-aos-delay="300">
                ...
                <div className="lg:me-8 order-2 md:order-1 " data-aos="fade-right" data-aos-delay="300">
