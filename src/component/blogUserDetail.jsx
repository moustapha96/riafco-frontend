        ...
        <div className={props.className}>
            <div className="sticky top-20">
                ...
                <div className="text-center mt-8">
                    <img src={props.client ? props.client : image12} className="size-24 mx-auto rounded-full shadow-sm mb-4" alt="" />

                    <Link className="text-lg font-semibold hover:text-[var(--riafco-orange)]  transition-all duration-500 ease-in-out">{props.name ? props.name : 'Cristina Romsey'}</Link>
                ...
                {RecentPostData.map((data, index) => {
                    return(
                        <div className={data.Class} key={index}>
                            <img src={data.Image} className="h-16 rounded-md shadow-sm dark:shadow-gray-800" alt="" />
    
                            <div className="ms-3">
                                <Link className="font-semibold hover:text-[var(--riafco-orange)] ">{data.Title}</Link>
                ...
                <ul className="list-none text-center mt-8">
                    {TagscloudItem.map((data,index) => {
                        return(
                            <li className="inline-block m-2" key={index}><Link to="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-[var(--riafco-blue)] dark:hover:bg-[var(--riafco-blue)] rounded-md shadow-sm dark:shadow-gray-800 transition-all duration-500 ease-in-out">{data.item}</Link></li>
                        )
                    }
