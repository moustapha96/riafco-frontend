        ...
        <nav id="topnav" className={`${navbarSticky ? "nav-sticky" :" defaultscroll"}`}>
            <div className="container relative">
                ...
                <ul className="buy-button list-none mb-0">
                        ...
                        {isCart ?
                             ...
                             <ul className="py-3 text-start" aria-labelledby="dropdownDefault">
                                 <li>
                                     <Link to="/" className="flex items-center justify-between py-1.5 px-4">
                                         <span className="flex items-center">
                                             <img src={s1} className="rounded shadow-sm dark:shadow-gray-800 w-9" alt="" />
                                             <span className="ms-3">
                                 ...
                                 <li>
                                     <Link to="/" className="flex items-center justify-between py-1.5 px-4">
                                         <span className="flex items-center">
                                             <img src={s2} className="rounded shadow-sm dark:shadow-gray-800 w-9" alt="" />
                                             <span className="ms-3">
                                 ...
                                 <li>
                                     <Link to="/" className="flex items-center justify-between py-1.5 px-4">
                                         <span className="flex items-center">
                                             <img src={s3} className="rounded shadow-sm dark:shadow-gray-800 w-9" alt="" />
                                             <span className="ms-3">
                    ...
                    {showModal ? <div id="ContactUs"  className="bg-gray-900/50  fixed inset-0 z-40 flex items-center justify-center">
