...
//   getAll: () => axiosInstance.get('/resources'),
//   getById: (id) => axiosInstance.get(`/resources/${id}`),
//   download: (id) => axiosInstance.get(`/resources/${id}/download`, { responseType: 'blob' }),
//   create: (formData) => axiosInstance.post('/resources', formData, {
//     headers: { 'Content-Type': 'multipart/form-data' },
//   }),
//   update: (id, formData) => axiosInstance.put(`/resources/${id}`, formData, {
//     headers: { 'Content-Type': 'multipart/form-data' },
//   }),
