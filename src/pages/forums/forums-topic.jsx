            ...
            <section className="relative table w-full py-32 lg:py-40 bg-gray-50 dark:bg-slate-800">
                ...
                <div className="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
                    <ul className="tracking-[0.5px] mb-0 inline-flex space-x-1">
                        ...
                        <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out hover:text-[var(--riafco-orange)] "><Link to="/index-forums">Forum</Link></li>
                        <li className="inline-block text-base text-slate-950 dark:text-white mx-0.5 ltr:rotate-0 rtl:rotate-180"><MdKeyboardArrowRight className="text-xl"/></li>
                        <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out text-[var(--riafco-orange)] " aria-current="page">Techwind Announcements</li>
                    </ul>
                </div>
            </section>
                                        ...
                                        <tr className="border-b border-gray-100 dark:border-slate-800">
                                            <th className="text-start p-4">
                                                <div className="flex items-start">
                                                    <FaRegComments className="text-[var(--riafco-orange)]  text-2xl" />

                                                    <div className="ms-2">
                                                        <Link to="/forums-comments" className="hover:text-[var(--riafco-orange)]  text-lg">Changelog</Link>
                                                        <p className="text-slate-400 font-normal">Write by: <Link className="text-[var(--riafco-orange)] ">Calvin Carlo</Link></p>
                                                    </div>
                                                </div>
                                            </th>
                                        ...
                                        <tr className="border-b border-gray-100 dark:border-slate-800">
                                            <th className="text-start p-4">
                                                <div className="flex items-start">
                                                    ...
                                                    <div className="ms-2">
                                                        <Link to="/forums-comments" className="hover:text-[var(--riafco-orange)]  text-lg">Documentation</Link>
                                                        <p className="text-slate-400 font-normal">Write by: <Link className="text-[var(--riafco-orange)] ">Alia Reddy</Link></p>
                                                    </div>
                                                </div>
                                            </th>
                                        ...
                                        <tr className="border-b border-gray-100 dark:border-slate-800">
                                            <th className="text-start p-4">
                                                <div className="flex items-start">
                                                    ...
                                                    <div className="ms-2">
                                                        <Link to="/forums-comments" className="hover:text-[var(--riafco-orange)]  text-lg">Components</Link>
                                                        <p className="text-slate-400 font-normal">Write by: <Link className="text-[var(--riafco-orange)] ">Cristino Murphy</Link></p>
                                                    </div>
                                                </div>
                                            </th>
                        ...
                        <div className="lg:col-span-4 md:col-span-6">
                            <div className="sticky top-20">
                                ...
                                <div className="flex items-center mt-8">
                                    <img src={imageP} className="h-16 rounded-md shadow-sm dark:shadow-gray-800" alt="" />
                                ...
                                <div className="flex items-center mt-4">
                                    <img src={image1} className="h-16 rounded-md shadow-sm dark:shadow-gray-800" alt="" />
                                ...
                                <div className="flex items-center mt-4">
                                    <img src={image2} className="h-16 rounded-md shadow-sm dark:shadow-gray-800" alt="" />
