                ...
                <div className="container relative">
                    ...
                    <div className="relative mt-3">
                        <ul className="tracking-[0.5px] mb-0 inline-flex space-x-1">
                            ...
                            <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out text-[var(--riafco-orange)] " aria-current="page">Checkout</li>
                        </ul>
                    </div>
                </div>
            </section>
                            ...
                            <div className="p-6 rounded-md shadow-sm dark:shadow-gray-800">
                                    ...
                                    <div className="grid lg:grid-cols-12 grid-cols-1 mt-6 gap-5">
                                        ...
                                        <div className="lg:col-span-12">
                                            <div className="flex items-center w-full mb-0">
                                                <input className="form-checkbox rounded border-gray-200 dark:border-gray-800 text-[var(--riafco-orange)]  focus:border-indigo-300 focus:ring focus:ring-offset-0 focus:ring-indigo-200 focus:ring-opacity-50 me-2" type="checkbox" value="" id="sameaddress" />
                                ...
                                <h3 className="text-xl leading-normal font-semibold mt-6">Payment</h3>
                                        <form>
                                            <div className="grid lg:grid-cols-12 grid-cols-1 mt-6 gap-5">
                                                <div className="lg:col-span-12">
                                                    <div className="block">
                                                        ...
                                                        <input type="radio" readOnly className="form-radio border-gray-200 dark:border-gray-800 text-[var(--riafco-orange)]  focus:border-indigo-300 focus:ring focus:ring-offset-0 focus:ring-indigo-200 focus:ring-opacity-50 me-2" name="radio-colors" value="1" checked />
                                                    ...
                                                    <div className="block mt-2">
                                                        <div>
                                                            <label className="inline-flex items-center">
                                                        <input type="radio" readOnly className="form-radio border-gray-200 dark:border-gray-800 text-[var(--riafco-orange)]  focus:border-indigo-300 focus:ring focus:ring-offset-0 focus:ring-indigo-200 focus:ring-opacity-50 me-2" name="radio-colors" value="1" />
                                            ...
                                            <input type="number" readOnly className="form-input w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-[var(--riafco-blue)] dark:border-gray-800 dark:focus:border-[var(--riafco-blue)] focus:ring-0 mt-2" placeholder="" id="cvv" name="number" required="" />
                                                </div>
                                            </div>
                                        </form>       
                               
                                <div className="mt-4">
                                    <input type="submit" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-[var(--riafco-blue)] hover:bg-[var(--riafco-blue] border-[var(--riafco-blue)] hover:border-[var(--riafco-blue] text-white rounded-md w-full" value="Continue to checkout" />
                                </div>
                            </div>
                        ...
                        <div className="lg:col-span-4">
                            <div className="p-6 rounded-md shadow-sm dark:shadow-gray-800">
                                <div className="flex justify-between items-center">
                                    ...
                                    <Link className="bg-[var(--riafco-blue)] flex justify-center items-center text-white text-[10px] font-bold px-2.5 py-0.5 rounded-full h-5">3</Link>
                                </div>
