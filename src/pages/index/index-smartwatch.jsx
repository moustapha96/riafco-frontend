                ...
                <div className="container relative">
                    <div className="grid grid-cols-1 pb-8 mt-10">
                        <div className="grid grid-cols-1 mt-10">
                            <h5 className="text-[var(--riafco-orange)]  text-lg font-medium">Here to turn make hand turn</h5>
                    ...
                    <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                            ...
                            <div className="relative">
                                ...
                                <div className="absolute bottom-16 end-0">
                                    ...
                                    <div className="absolute bottom-2/4 translate-y-2/4 start-0 end-0 text-center">
                                        <Link to="#" onClick={() => setOpen(true)} data-type="youtube" data-id="S_CGed6E610" className="lightbox size-14 rounded-full shadow-lg inline-flex items-center justify-center bg-white text-[var(--riafco-orange)] ">
                        ...
                        <div className="md:col-span-7">
                            <div className="lg:ms-4">
                                <h5 className="font-medium text-lg text-[var(--riafco-orange)] ">Nice Top Series</h5>
            ...
            <section className="relative md:py-24 py-16">
              <div className="container relative">
                    ...
                    <div className="grid lg:grid-cols-12 md:grid-cols-12 grid-cols-1 mt-8 gap-[30px] items-center">
                        ...
                        <div className="grid grid-cols-1 gap-[30px]">
                            <div className="group flex transition-all duration-500 ease-in-out xl:p-3">
                                    <div className="flex align-middle justify-center items-center size-14 mt-1 bg-[var(--riafco-blue)]/5 group-hover:bg-[var(--riafco-blue)] group-hover:text-white border-2 border-[var(--riafco-blue)]/20 text-[var(--riafco-orange)]  rounded-lg text-2xl shadow-sm dark:shadow-gray-800 transition-all duration-500 ease-in-out">
