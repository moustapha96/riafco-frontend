    ...
    return (
        <>
            ...
            <section className="relative table w-full py-36 md:py-56 md:pb-0 overflow-hidden bg-[url('../../assets/images/app/bg.png')] bg-top bg-no-repeat bg-fixed bg-cover">
                <div className="absolute inset-0 bg-[var(--riafco-blue)] opacity-80"></div>
                <div className="container relative z-2">
                    <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                        ...
                        <div className="lg:col-span-4 md:col-span-5 md:mt-0">
                            <div className="relative after:content-[''] after:absolute after:h-40 after:wz-40 after:bg-[var(--riafco-blue)] after:bottom-0 after:end-0  after:-z-0 after:rounded-3xl after:animate-[spin_10s_linear_infinite]">
                        ...
                        {appFeature.map((item,index)=>{
                            ...
                            return(
                                <div key={index} className="group p-6 md:px-4 rounded-lg shadow-sm dark:shadow-gray-800 hover:shadow-md dark:hover:shadow-gray-700 bg-white dark:bg-slate-900 text-center transition-all duration-500 ease-in-out">
                                    <div
                                        className="size-16 bg-[var(--riafco-blue)]/5 text-[var(--riafco-orange)]  rounded-lg text-2xl flex align-middle justify-center items-center shadow-sm dark:shadow-gray-800 mx-auto">
                                        <Icons width={30}/>
                                    </div>
                ...
                <div className="container relative md:mt-24 mt-16">
                    <div className="grid md:grid-cols-2 grid-cols-1 items-center mt-16 gap-[30px]">
                        <div className="relative">
                            ...
                            <div className="overflow-hidden absolute lg:size-[400px] size-[320px] bg-[var(--riafco-blue)]/5 bottom-2/4 translate-y-2/4 start-0 rotate-45 -z-1 shadow-md shadow-[var(--riafco-blue)]/10 rounded-[100px]"></div>
                        </div>
                ...
                <div className="container relative md:mt-24 mt-16">
                    <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                        <div className="relative order-1 md:order-2">
                            ...
                            <div className="overflow-hidden absolute lg:size-[400px] size-[320px] bg-[var(--riafco-blue)]/5 bottom-2/4 translate-y-2/4 end-0 rotate-45 -z-1 shadow-md shadow-[var(--riafco-blue)]/10 rounded-[100px]"></div>
                        </div>
