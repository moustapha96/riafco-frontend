    ...
    return (
        <>
            ...
            <section className="relative table w-full py-36 lg:py-64 bg-[url('../../assets/images/event/bg.jpg')] bg-no-repeat bg-center bg-cover">
                <div className="absolute inset-0 bg-gradient-to-t from-[var(--riafco-blue)]/90 to-fuchsia-600/90"></div>
                <div className="container relative">
                    <div className="grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
                        <div className="lg:col-span-8 md:col-span-7 md:order-1 order-2">
                            ...
                            <div className="mt-8">
                                <Link to="/#ticket" className="py-2 px-5 inline-flex items-center font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-[var(--riafco-blue)] hover:bg-[var(--riafco-blue] border-[var(--riafco-blue)] hover:border-[var(--riafco-blue] text-white rounded-md"><FaRegEnvelope className="me-2 text-sm" /> Buy Ticket</Link>
                            </div>
                        </div>
            ...
            <section className="relative md:py-24 py-16">
                    ...
                    <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                        <div className="md:col-span-6">
                            <div className="grid grid-cols-12 gap-4 items-center">
                                ...
                                <div className="col-span-5">
                                    <div className="grid grid-cols-1 gap-4">
                                        <img src={image1} className="shadow-sm rounded-lg" alt="" />
                        ...
                        <div className="md:col-span-6">
                            <div className="lg:ms-5">
                                <h6 className="text-[var(--riafco-orange)]  text-sm font-bold uppercase mb-2">Outpace Your Competition</h6>
                                ...
                                <div className="flex mt-6">
                                    <PiMapPinLight className="text-[var(--riafco-orange)]  text-4xl me-4 mt-2" />
                                    <div className="">
                                ...
                                <div className="flex mt-6">
                                    <GoClock className="text-[var(--riafco-orange)]  text-3xl me-4 mt-2" />
                                    <div className="">
                ...
                <div className="container relative md:mt-24 mt-16">
                    <div className="grid grid-cols-1 pb-8 text-center">
                        <h6 className="text-[var(--riafco-orange)]  text-sm font-bold uppercase mb-2">Event Speakers</h6>
                                                ...
                                                <tbody>
                                                    {eventThree.map((item,index)=>{
                                                            ...
                                                            <tr key={index}>
                                                                ...
                                                                <td className="text-end border-b border-gray-100 dark:border-gray-700 py-12 px-5 min-w-[180px]">
                                                                        <Link to="#" className="relative inline-flex items-center tracking-wide align-middle text-base text-center border-none after:content-[''] after:absolute after:h-px after:w-0 hover:after:w-full after:end-0 hover:after:end-auto after:bottom-0 after:start-0 after:transition-all after:duration-500 font-medium hover:text-[var(--riafco-orange)]  after:bg-[var(--riafco-blue)] duration-500 ease-in-out">Buy Ticket <FaArrowRight /></Link>
                                                                </td>
                                                            </tr>
                                                            )
                                                        })}
            ...
            <section className="relative table w-full py-36 bg-[url('../../assets/images/event/bg2.jpg')] bg-no-repeat bg-center bg-cover">
                ...
                <div className="container relative">
                    <div className="grid grid-cols-1 text-center">
                        <Link to="#" onClick={() => setOpen(true)} data-id="S_CGed6E610" className="lightbox size-20 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-[var(--riafco-orange)]  mx-auto mb-12">
                    ...
                    <div className="grid lg:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                        <div className="lg:col-span-5">
                            <div className="lg:text-start text-center">
                                <h6 className="text-[var(--riafco-orange)]  text-sm font-bold uppercase mb-2">Secure Your Place Now</h6>
                                ...
                                <div className="grid md:grid-cols-2 grid-cols-1 md:gap-0 gap-[30px]">
                                    <div className="group border-b-[3px] border-gray-200 dark:border-gray-700 relative shadow-sm dark:shadow-gray-800 rounded-md md:scale-110 z-3 bg-white dark:bg-slate-900">
                                        <div className="p-6 py-8">
                                            <h6 className="font-bold uppercase mb-5 text-[var(--riafco-orange)] ">Personal</h6>
                                            ...
                                            <ul className="list-none text-slate-400">
                                                <li className="mb-1 flex items-center ms-0"><BsCheckCircle className="text-[var(--riafco-orange)]  text-base me-2" /> Full Access</li>
                                                <li className="mb-1 flex items-center ms-0"><BsCheckCircle className="text-[var(--riafco-orange)]  text-base me-2" /> Source Files</li>
                                                <li className="mb-1 flex items-center ms-0"><BsCheckCircle className="text-[var(--riafco-orange)]  text-base me-2" /> Free Appointments</li>
                                                <li className="mb-1 flex items-center ms-0"><BsCheckCircle className="text-[var(--riafco-orange)]  text-base me-2" /> Enhanced Security</li>
                                            </ul>
                                            <Link to="#" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-[var(--riafco-blue)] hover:bg-[var(--riafco-blue] border-[var(--riafco-blue)] hover:border-[var(--riafco-blue] text-white rounded-md mt-5">Get Started</Link>
                                        </div>
                                    </div>
