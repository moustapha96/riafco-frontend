            ...
            <section className="flex md:h-screen py-36 items-center bg-[url('../../assets/images/law/bg.jpg')] bg-center bg-no-repeat bg-cover">
                ...
                <div className="container relative">
                    <div className="grid grid-cols-1 mt-10">
                        ...
                        <div className="mt-8">
                            <Link to="#" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-[var(--riafco-blue)] hover:bg-[var(--riafco-blue] border-[var(--riafco-blue)] hover:border-[var(--riafco-blue] text-white">Get Started</Link>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="pt-20 pb-32 w-full table relative bg-[url('../../assets/images/business/bg02.jpg')] bg-center bg-no-repeat bg-cover">
                ...
                <div className="container relative">
                    <div className="grid grid-cols-1 text-center">
                        ...
                        <div className="mt-6">
                            <Link to="#" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-[var(--riafco-blue)] hover:bg-[var(--riafco-blue] border-[var(--riafco-blue)] hover:border-[var(--riafco-blue] text-white rounded-md me-2 mt-2">Free Consultation</Link>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container relative">
                    <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center mt-10 gap-[30px]">
                            ...
                            <div className="lg:ms-10 relative">
                                <div className="bg-white dark:bg-slate-900 rounded-md shadow-sm dark:shadow-gray-800 p-6">
                                    ...
                                    <form>
                                        ...
                                        <button type="submit" id="submit" name="send" className="py-2 px-5 font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-[var(--riafco-blue)] hover:bg-[var(--riafco-blue] border-[var(--riafco-blue)] hover:border-[var(--riafco-blue] text-white rounded-md justify-center flex items-center mt-3">Send Message</button>
                                    </form>
                                </div>
                                <div className="overflow-hidden absolute lg:size-[400px] size-[320px] bg-[var(--riafco-blue)]/5 bottom-0 end-0 rotate-45 -z-1 rounded-3xl"></div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-7 md:order-1 order-2">
                            ...
                            <ul className="list-none text-slate-400 mt-4">
                                <li className="mb- items-center1 flex"><BsCheckCircle className="text-[var(--riafco-orange)]  text-base me-2" /> Digital Marketing Solutions for Tomorrow</li>
                                <li className="mb- items-center1 flex"><BsCheckCircle className="text-[var(--riafco-orange)]  text-base me-2" /> Our Talented & Experienced Marketing Agency</li>
                                <li className="mb- items-center1 flex"><BsCheckCircle className="text-[var(--riafco-orange)]  text-base me-2" /> Create your own skin to match your brand</li>
                            </ul>
