                            ...
                            <div key={index} className="p-1 picture-item" >
                                 <div className="group relative block overflow-hidden rounded-md transition-all duration-500">
                                    ...
                                    <div className="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center opacity-0 group-hover:opacity-100 duration-500">
                                             <Link onClick={() => handleImageClick(index)} className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-[var(--riafco-blue)] hover:bg-[var(--riafco-blue] border border-[var(--riafco-blue)] hover:border-[var(--riafco-blue] text-white lightbox"><FiCamera className='size-4' /></Link>
                                    </div>
                                </div>
                            </div>
                                 )
