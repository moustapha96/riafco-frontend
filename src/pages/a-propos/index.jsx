...
//       <Navbar />
//       <HeaderBreakdumb title="à propos" />
...
export default function AproposPage() {
  ...
  return (
    <div>
      ...
      {/* Section principale avec le contenu "About Us" */}
      <section className="relative table w-full py-36 lg:py-44">
        <div className="container relative">
          <div className="grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
            <div className="md:col-span-7">
              <div className="me-6">
                <h4 className="font-semibold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 text-black dark:text-white">
                  {aboutUs ? aboutUs.title_fr : "Chargement..."}
                </h4>
                <p className="text-slate-400 text-lg max-w-xl">
                  {aboutUs ? aboutUs.paragraphe_fr.split('\n').map((line, index) => (
                    line.trim() !== "" && <span key={index}>{line}<br /><br /></span>
            ...
            <div className="md:col-span-5">
              {aboutUs && aboutUs.image && (
                <img src={aboutUs.image} alt="RIAFCO" className="w-full h-auto rounded-lg" />
              )}
            </div>
          </div>
        </div>
      ...
      {/* Section des missions du RIAFCO */}
      <section className="relative md:py-24 py-16 bg-gray-50 dark:bg-slate-800">
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center">
          ...
          <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center mt-10 gap-[30px]">
            <div className="lg:col-span-5">
              <img src={SEO_SVG} alt="Missions RIAFCO" />
            </div>
            <div className="lg:col-span-7">
              <div className="lg:ms-10">
                <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">
                ...
                <p className="text-slate-400 max-w-xl">
                  Le RIAFCO vise à renforcer les capacités des Institutions de Financement des Collectivités Locales (IFCL) et à promouvoir leur rôle dans le développement local.
                </p>
                <ul className="list-none text-slate-400 mt-4">
                  <li className="mb-1 flex items-center m-0">
                    <BsCheckCircle className="text-indigo-600 text-base me-2" />
                    Encourager les échanges entre pairs
                  </li>
                  <li className="mb-1 flex items-center m-0">
                    <BsCheckCircle className="text-indigo-600 text-base me-2" />
                    Renforcer les IFCL par des formations et une expertise technique
                  </li>
                  <li className="mb-1 flex items-center m-0">
                    <BsCheckCircle className="text-indigo-600 text-base me-2" />
                    Plaidoyer pour la reconnaissance des IFCL
                  </li>
                </ul>
              </div>
            </div>
      ...
      <section className="relative md:py-24 py-16">
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center">
            <h6 className="mb-4 text-base font-medium text-indigo-600">Nous croyons en la construction mutuelle et travaillons donc</h6>
            <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">
              Avec des partenaires incroyables
            </h3>
            <p className="text-slate-400 max-w-xl mx-auto">
              Découvrez nos partenaires qui nous accompagnent dans nos missions.
            </p>
          </div>
          <div className="grid relative grid-cols-1 mt-8">
            <div className="tiny-two-item">
                  ...
                  <div className="tiny-slide" key={index}>
                    <div className="lg:flex p-6 lg:p-0 relative rounded-md shadow-sm dark:shadow-gray-800 overflow-hidden m-2">
                      ...
                      <div className="pt-6 lg:p-6 text-center lg:text-start space-y-4">
                        ...
                        <div>
                          <span className="text-indigo-600 block mb-1">{partner.name}</span>
