                ...
                <div className="container relative">
                    <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                        <div className="lg:col-span-8 md:col-span-6">
                            <div className="p-6 pt-0 rounded-md shadow-sm dark:shadow-gray-800">
                                ...
                                <div className="text-center mt-12">
                                    <span className="bg-[var(--riafco-blue)] inline-block text-white text-xs font-semibold px-2.5 py-0.5 rounded-full h-5">Vimeo</span>
