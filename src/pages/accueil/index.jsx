        ...
        <div>
            ...
            {/* <section className="swiper-slider-hero relative block h-screen" id="home">
                <div className="swiper-container swiper-container-initialized swiper-container-horizontal h-full">
                    ...
                    >
                        <SwiperSlide>
                            <div className="relative table w-full py-36 lg:py-64" style={{ backgroundImage: `url(${image1})` }}>
                        ...
                        <SwiperSlide>
                            <div className="relative table w-full py-36 lg:py-64" style={{ backgroundImage: `url(${image2})` }}>
                                <div className="slide-inner slide-bg-image flex items-center bg-center w-full">
                                    <div className="absolute inset-0 bg-black/70"></div>
                                    <div className="container relative">
                                        <div className="grid grid-cols-1 text-center mt-10">
                                            <div className="text-center">
                                                <h1 className="font-bold text-white lg:leading-normal text-4xl lg:text-5xl mb-5"
