...
export default function Accueil() {
    ...
    return (
        <div>
            ...
            <section className="relative table w-full py-36 lg:py-64 bg-[url('../../assets/images/corporate/bg-afrique.jpg')] bg-no-repeat bg-center bg-cover">
                <div className="absolute inset-0 bg-gradient-to-b from-black/70 to-transparent"></div>
                <div className="container relative">
                    <div className="grid grid-cols-1 text-center mt-10">
                        <span className="text-white/80 font-bold text-sm mb-3">RIAFCO EN ACTION</span>
                        <h1 className="font-bold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 text-white">
                            Renforcer la coopération <span className="text-[--riafco-orange]">inter-africaine</span> <br />
                            pour un développement durable
                        </h1>
                        <p className="text-white/80 text-lg max-w-2xl mx-auto mb-8">
                            Découvrez comment RIAFCO connecte les acteurs du développement en Afrique à travers des projets collaboratifs,
                            des ressources partagées et des événements fédérateurs.
                        </p>
          ...
          text-white rounded-md"
                            >
                                En savoir plus <FaArrowRight className="ms-2 text-[10px]" />
                            </Link>
                            <Link
                                to="/members"
                                className="py-3 px-6 inline-flex items-center font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center
          ...
          text-white hover:text-white rounded-md"
                            >
                                Découvrir nos membres <FaArrowRight className="ms-2 text-[10px]" />
                            </Link>
                        </div>
                    </div>
                </div>
            ...
            <section className="relative py-16 bg-[--riafco-blue]">
                <div className="container relative">
                        ...
                        {[
                            {
                                ...
                                desc: "Une plateforme pour connecter les acteurs du développement à travers l’Afrique.",
                            },
                            {
                                icon: AiOutlineCheckCircle,
                                title: "Ressources Partagées",
                                desc: "Accédez à une bibliothèque de documents, études et outils pour vos projets.",
                            },
                            {
                                icon: AiOutlineCheckCircle,
                                title: "Événements Collaboratifs",
                                desc: "Participez à des webinaires, ateliers et conférences pour échanger et innover.",
                            },
                            {
                                icon: AiOutlineCheckCircle,
                                title: "Espace Membre Sécurisé",
                                desc: "Un espace dédié pour collaborer, discuter et partager en toute sécurité.",
                            },
                        ].map((item, index) => (
                            <div key={index} className="group px-6 py-8 hover:bg-[--riafco-blue-hover] duration-500 ease-in-out rounded-lg">
                                ...
                                <div className="content mt-6">
                                    ...
                                    <div className="mt-5">
                                        <Link
                                            to="#"
                                            className="relative inline-flex items-center font-semibold tracking-wide align-middle text-base text-center
                border-none after:content-[''] after:absolute after:h-px after:w-0 hover:after:w-full after:end-0
                hover:after:end-auto after:bottom-0 after:start-0 after:transition-all after:duration-500
                text-white hover:text-white after:bg-white duration-500 ease-in-out"
                                        >
                                            En savoir plus <FaArrowRight className="ms-2 text-[10px]" />
                                        </Link>
                                    </div>
                        ...
                        <div className="lg:col-span-4 md:col-span-6 lg:order-1 order-2 lg:text-center">
                            <Link
                                ...
                                className="size-20 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center
                                                                     bg-[--riafco-orange] hover:bg-[--riafco-orange-hover] text-white duration-500 ease-in-out mx-auto"
                            >
                                <i className="mdi mdi-information inline-flex items-center justify-center text-2xl"></i>
                            </Link>
                            <h6 className="text-[--riafco-blue] text-sm font-bold uppercase mt-8 mb-2">À Propos de RIAFCO</h6>
                            <h3 className="mb-4 md:text-4xl md:leading-normal text-3xl leading-normal font-bold">
                                Qui sommes-nous ?
                            </h3>
                            <p className="text-slate-600 max-w-xl">
                                RIAFCO est un réseau panafricain dédié à la coopération et au développement durable.
                                Nous connectons les acteurs publics, privés et associatifs pour des projets communs en Afrique.
                            </p>
                        </div>
            ...
            <section className="relative md:py-24 py-16">
                            ...
                            <div className="">
                                <div className="relative">
                                    <div className="shadow-sm dark:shadow-gray-800 p-5 pb-0 rounded-md bg-emerald-600/5 dark:bg-emerald-600/30">
                                        <img src={image1} className="rounded-t-md shadow-sm" alt="" />
                                    </div>
                                </div>
                ...
                <ActiviteSection className="container relative md:mt-24 mt-16" id={""} />
