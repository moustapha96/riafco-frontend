...
import {HiOutlineArrowsExpand, HiOutlineChartPie, HiOutlineUsers} from 'react-icons/hi'
...
import { VscFeedback, VscMention, VscServer } from 'react-icons/vsc';
import { TbAward, TbCameraPlus, TbCloudUp, TbCurrencyBitcoin, TbUserCheck } from 'react-icons/tb';
import { BsBriefcase, BsCheckCircle, BsEnvelopeAt, BsPencil, BsSuitClub } from 'react-icons/bs';
import { LuAirplay, LuAtom, LuImagePlus, LuSave, LuUsers } from 'react-icons/lu';
import { BiCube, BiDna, BiLineChart, BiLogoDribbble, BiShieldAlt2, BiTachometer, BiWallet } from 'react-icons/bi';
import { FiAirplay, FiDisc, FiKey } from 'react-icons/fi';
import { MdApi, MdOutlineBrightness5, MdOutlineCalendarMonth, MdOutlineCollectionsBookmark, MdOutlineMonitorWeight } from 'react-icons/md';
import { LiaDiscord, LiaFileInvoiceDollarSolid, LiaSwatchbookSolid } from 'react-icons/lia';
import { AiOutlineCompass, AiOutlineDollar, AiOutlineFire, AiOutlineGitlab, AiOutlineHome, AiOutlineStar } from 'react-icons/ai';
import { PiBellSimpleRingingBold, PiBookOpenText, PiBriefcase, PiFlowerLight } from 'react-icons/pi';
import { RiBatteryChargeLine, RiBitCoinLine, RiCheckboxMultipleBlankLine, RiMailSendLine, RiMoneyCnyBoxLine, RiPresentationFill } from 'react-icons/ri';
import { HiOutlineCog6Tooth } from 'react-icons/hi2';
import { FaRegComment, FaRegComments, FaRegQuestionCircle } from 'react-icons/fa';
...
export const servicesTwo = [
    {
        ...
        title:"UX / UI Design",
        desc:"The phrasal sequence of the is now so that many campaign and benefit",
        shadow:'p-6 hover:shadow-xl hover:shadow-gray-100 dark:hover:shadow-gray-800 duration-500 rounded-2xl mt-6'
    },
    {
        icon:MdApi,
        title:"IOS App Designer",
        desc:"The phrasal sequence of the is now so that many campaign and benefit",
        shadow:'p-6 shadow-xl shadow-gray-100 dark:shadow-gray-800 duration-500 rounded-2xl mt-6'
    },
    {
        icon:TbCameraPlus,
        title:"Photography",
...
export const paymentFeature = [
    {
        ...
        desc:"The phrasal sequence of the is now so that many campaign and benefit",
        bgClass:'p-6 hover:shadow-xl hover:shadow-gray-100 dark:hover:shadow-gray-800 transition duration-500 rounded-2xl mt-6 text-center'
    },
    {
        icon:MdOutlineCalendarMonth,
        title:"Easy to use",
        desc:"The phrasal sequence of the is now so that many campaign and benefit",
        bgClass:'p-6 shadow-xl shadow-gray-100 dark:shadow-gray-800 duration-500 rounded-2xl mt-6 text-center'
    },
    {
        icon:RiMailSendLine,
        title:"Support",
        desc:"The phrasal sequence of the is now so that many campaign and benefit",
         bgClass:'p-6 hover:shadow-xl shadow-gray-100 dark:hover:shadow-gray-800 transition duration-500 rounded-2xl mt-6 text-center'
    },
]
export const personalServices =[
    {
        ...
        bgClass:"p-6 hover:shadow-xl hover:shadow-gray-100 dark:hover:shadow-gray-800 transition duration-500 rounded-2xl mt-6"
    },
    {
        icon:MdApi,
        title:"IOS App Designer",
        decs:"The phrasal sequence of the is now so that many campaign and benefit",
        bgClass:"p-6 shadow-xl shadow-gray-100 dark:shadow-gray-800 duration-500 rounded-2xl mt-6"
    },
    {
        icon:TbCameraPlus,
        title:"Photography",
